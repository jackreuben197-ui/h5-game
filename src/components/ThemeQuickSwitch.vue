...
<template>
  <button
    ...
    role="switch"
    :aria-checked="isDark"
    :aria-label="tJoin(t('UIComponent_Text8'), targetThemeLabel, t('UIGameplaySetting_DesktopSetting_Theme'))"
    :title="tJoin(t('UIComponent_Text8'), targetThemeLabel, t('UIGameplaySetting_DesktopSetting_Theme'))"
