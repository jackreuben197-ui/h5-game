...
export const DEBUG_ACCOUNTS: DebugAccount[] = [
  ...
  { account: '13110105062', nickname: '13110105062', password: '1011abc' },
  { account: '13010105062', nickname: '13010105062', password: '1011abc' },
...
export const DEFAULT_DEBUG_ACCOUNT =
  DEBUG_ACCOUNTS.find((item) => item.account === '18410105002') ?? DEBUG_ACCOUNTS[0]
