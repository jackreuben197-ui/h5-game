...
const MOCK_FRIEND_ROOMS: RoomcenterFriendRoomRecord[] = [
  {
    rid: 96538296,
    name: '蘑菇桌-1',
    room_type: 0,
    ...
    roomers: 6,
    play_duration: 28800,
    start_time: '2026-05-11T04:18:01Z',
    end_time: null,
    hand_num: 385,
    tribe_id: 35,
    ...
    play_hands_limit: 0,
    insurance_mode: 0,
    auto_change_room_limit_hand: 0,
    all_in_mute: 2,
    wheel_template_id: 0,
    squid_count_rate: null,
    mini_game_template_id: 0,
    insurance_force_buy_ratio: 0,
    bomb_double_type: 0,
    bomb_six_begin_reward: 0,
    pass_ace_three_time: 0,
    double_low_level_up_type: 0,
    auto_create_room: 0,
    squid_leave_mode: 1,
    power_saving: 2,
    squid_player_count: 0,
    tribe_club_ids: '',
    tribe_specify_club: 0,
    create_time: '2026-05-11T04:17:46Z',
    update_time: '2026-05-11T09:56:10Z',
    mic_seat_switch: 1,
    mic_middle_switch: 2,
    video_seat_switch: 1,
    video_middle_switch: 2,
    power_saving_seat_switch: 2,
    power_saving_middle_switch: 1,
    users: [
      {
        un: 91109922,
        name: 'player',
        avatar:
          'https://static.awanptest.com/awanptesting-intl-test/image-normal/20220310094520-FKeDL.png',
        wallet: 0,
        seat: 6,
        cheat_studio_id: 0,
        forbidden: false,
      ...
      },
      {
        un: 98343558,
        name: '未處理',
        avatar: 'https://static.awanptest.com/pint-intl-test/image-normal/20251230130947-bATKb.jpg',
        wallet: 0,
        seat: 2,
        cheat_studio_id: 0,
        forbidden: false,
      ...
      },
      {
        un: 94343558,
        name: '未處理2',
        avatar: 'https://static.awanptest.com/pint-intl-test/image-normal/20251230130947-FvkVj.jpg',
        wallet: 0,
        seat: 3,
        cheat_studio_id: 0,
        forbidden: false,
      ...
      },
      {
        ...
        name: '张众',
        avatar:
          'https://static.awanptest.com/awanptesting-intl-test/image-normal/20220310094859-noCSy.png',
        wallet: 0,
        seat: 7,
        cheat_studio_id: 0,
        forbidden: false,
      ...
      },
      {
        ...
        name: 'player',
        avatar:
          'https://static.awanptest.com/awanptesting-intl-test/image-normal/20220310094721-zdArt.png',
        wallet: 0,
        seat: 5,
        cheat_studio_id: 0,
        forbidden: false,
      ...
      },
      {
        ...
        name: '小王',
        avatar:
          'https://static.awanptest.com/awanptesting-intl-test/image-normal/20220310094553-yqSKO.png',
        wallet: 0,
        seat: 9,
        cheat_studio_id: 0,
        forbidden: false,
...
async function fetchFriendRooms(): Promise<void> {
  ...
  try {
    ...
    if (res.code === 0 && Array.isArray(res.data?.records) && res.data.records.length > 0) {
      ...
      friendRooms.value = MOCK_FRIEND_ROOMS
    }
  } catch (error) {
