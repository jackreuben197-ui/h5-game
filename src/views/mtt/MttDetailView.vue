  ...
  <div class="mtt-detail-page">
    ...
    <div class="mtt-detail-content">
      ...
      <template v-else-if="activeTab === 'players'">
        <div class="placeholder-section">玩家列表（待实现）</div>
      </template>
      <template v-else-if="activeTab === 'rewards'">
        <div class="placeholder-section">奖励结构（待实现）</div>
      </template>
      <template v-else-if="activeTab === 'tables'">
        <div class="placeholder-section">牌桌分布（待实现）</div>
      </template>
      <template v-else-if="activeTab === 'blinds'">
        <div class="placeholder-section">盲注结构（待实现）</div>
      </template>
    </div>
