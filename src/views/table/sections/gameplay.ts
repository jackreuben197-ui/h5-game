...
// insurance: 0=关，1=经典，2=低水位，3=EV，4=经典新版
...
export const gameplaySection: TableFormFieldConfig[] = [
  // ── 保险 ──────────────────────────────────────────────
  {
    type: 'select',
    label: '保险',
  ...
  // ── Jackpot — 客户端：jackpot=1 开启，jackpot=2 关闭 ──
  {
    type: 'switch',
    label: 'Jackpot',
  ...
  },
  {
    ...
    modelValue: 'jackpot_id',
    defaultValue: 0,
    options: [{ text: '默认模板', value: 0 }],
    visibleWhen: [{ field: 'jackpot', equals: 1 }],
  },
]
