...
// anti_cheat_type: 0=关 2=音频桌 3=视频桌
...
// video_mode when anti_cheat=3: 0=全时长 1=全程 2=摊牌时
...
export const securitySection: FormSection = {
  ...
  fields: [
    ...
    },
    {
      ...
      modelValue: 'video_mode',
      defaultValue: 0,
      options: VIDEO_MODE_OPTIONS,
      visibleWhen: [{ field: 'anti_cheat', equals: 3 }],
    },
    {
      type: 'switch',
      label: '区块链加密',
