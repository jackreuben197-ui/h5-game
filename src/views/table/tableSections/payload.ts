...
export function buildRoomConfigPayload(formState: NlhFormState): Record<string, unknown> {
  ...
  return {
    ...
    call_time_winline: formState.call_time === 1 ? (parseInt(formState.call_time_winline || '0') || 0) : 0,
    call_time_count: formState.call_time === 1 ? (parseInt(formState.call_time_count || '0') || 0) : 0,
